...
const I18N = {
    'zh-CN': {
        nav: ['主页', '探索', '通知', '聊天', 'ヤチヨ', '书签', '创作者工作室', 'Premium', '个人资料', '更多'],
        home: '主页',
        detail: '帖子',
        account: '账户资料',
        search: '搜索',
        premiumTitle: '订阅 つくよみ Premium',
        premiumDesc: '订阅以解锁新功能，享受つくよみ世界的完整体验。',
        subscribe: '订阅',
        whatsNew: '有什么新鲜事',
        forYou: '为你推荐',
        following: '正在关注',
    ...
    'ja-JP': {
        ...
        account: 'アカウント',
        search: '検索',
        premiumTitle: 'つくよみ Premium を購読',
        premiumDesc: '新機能を解放して、つくよみの世界をフル体験。',
        subscribe: '購読',
        whatsNew: 'いまどうしてる？',
        forYou: 'おすすめ',
        following: 'フォロー中',
